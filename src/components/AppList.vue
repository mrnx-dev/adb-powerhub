  ...
  >
    ...
    <div class="px-3 py-2 border-b border-theme-tertiary">
      <input
        ...
        class="w-full px-3 py-1.5 rounded-md bg-theme-btn border border-theme-tertiary text-sm text-theme-primary placeholder:text-theme-muted focus:outline-none focus:border-accent-emerald/50"
      />
    </div>
